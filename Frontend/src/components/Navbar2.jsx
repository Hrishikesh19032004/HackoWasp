        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="relative group">
              <button className="text-gray-700 font-medium text-lg hover:text-green-600 transition-all">
                More
              </button>
              <div className="absolute hidden group-hover:block bg-white shadow-lg rounded-lg p-4 mt-2 w-48 z-50">
                <Link
                  to="/impactful"
