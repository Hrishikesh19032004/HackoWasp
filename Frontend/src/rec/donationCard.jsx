...
export const MyPlugin =  ({ foodName, quantity, location, onDonate }) => {
  return (
    <div id="webcrumbs"> 
            	<div className="w-[300px] bg-green-500 text-white rounded-lg shadow p-4 flex flex-col items-center gap-2">
    	  <img
    	    src="https://tools-api.webcrumbs.org/image-placeholder/200/150/food/3"
    	    alt="Food Dish"
    	  ...
    	  <button onClick={onDonate} className="bg-white text-green-500 py-2 px-4 rounded-md font-medium transition hover:bg-green-100">
    	    Send Request
    	  </button>
    	</div> 
    </div>
